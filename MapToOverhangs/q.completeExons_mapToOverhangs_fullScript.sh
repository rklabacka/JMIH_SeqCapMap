...
#Give job a name
#PBS -N completeExons_mapToOverhangs_t2
...
# mkdir -p /scratch/rlk0015/Telag/Results_CompleteExonList/MapToOverhangs/WorkingDirectory
# echo "RLK_report: directory created: /scratch/rlk0015/Telag/Results_CompleteExonList/MapToOverhangs/WorkingDirectory"
# 
# # copy over clean SE fastq files
# cd /scratch/rlk0015/Telag/CleanedReads/SingleEnd/
# ls *_trimmed.fastq | parallel -j+0  --eta 'cp {} /scratch/rlk0015/Telag/Results_CompleteExonList/MapToOverhangs/WorkingDirectory'
# echo "RLK_report: clean SE fastq files copied to /scratch/rlk0015/Telag/Results_CompleteExonList/MapToOverhangs/WorkingDirectory"
...
cp /home/rlk0015/SeqCap/code/References/CompleteReferenceList/CompleteExons_Overhangs_Randy.fa .
echo "RLK_report: reference copy complete"

# index reference
bwa index -p exons -a is CompleteExons_Overhangs_Randy.fa
...
mkdir -p /home/rlk0015/SeqCap/Results_CompleteExonList/MapToOverhangs/stats
mkdir -p /home/rlk0015/SeqCap/Results_CompleteExonList/MapToOverhangs/counts
mkdir -p /home/rlk0015/SeqCap/Results_CompleteExonList/MapToOverhangs/avgDepth

# cp results to respective directories
cp *stats.txt /home/rlk0015/SeqCap/Results_CompleteExonList/MapToOverhangs/stats
cp *counts.txt /home/rlk0015/SeqCap/Results_CompleteExonList/MapToOverhangs/counts
cp *depth.txt /home/rlk0015/SeqCap/Results_CompleteExonList/MapToOverhangs/avgDepth
